...
public class MulMatrix
{
	...
	//Desc: Scanner input reads in elements from keyboard into matrix m.
	//Input:	Keyboard supplies the  values of the matrix, entered in row-major 
	//	(the values of row 1 followed by values of row 2 and so on),separated by white 
	//	space.  
	...
	//Desc: Prints out matrix m
	//Output: Prints out matrix m, each row in a separate line, elements separated by white space.	
	...
	//Desc: Multiplies matricies m1 and m2, giving the product
	//Return: Matrix result, the product of matricies m1 and m2
